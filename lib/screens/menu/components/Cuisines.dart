...
class cuisinesFoods extends StatefulWidget {
  final String docid;
  cuisinesFoods({required this.docid});

  @override
  State<cuisinesFoods> createState() => _cuisinesFoodsState();
}

class _cuisinesFoodsState extends State<cuisinesFoods> {
  @override
